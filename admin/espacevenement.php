            ...
            <div class="breadcrumb-holder container-fluid">
                <ul class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">Marketing</li>
                            ...
                            <table border="1" class="table">
                                ...
                                foreach($listeEvenement as $row){
                                    ...
                                    <tr>
                                        ...
                                        <td><form method="GET" action="view/modifierevenement.php">
                                        ...
                                        <td>
                                        <form method="POST" action="view/supprimerevenement.php" >
                            ...
                            <center>
                              <a href="view/formulairevenement.php" class="btn btn-primary"> ajouter</a>
                                <a href="index.html" class="btn btn-primary"> retour</a>
                                <a href="view/statistiqueevenement.php" class="btn btn-primary"> Statistiques des événements</a>
