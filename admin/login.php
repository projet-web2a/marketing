            ...
            <div class="row">
                ...
                <div class="col-lg-6 bg-white">
                    <div class="form d-flex align-items-center">
                        <div class="content">
                            <form id="form1" name="form1" method="POST" action="view/connexion.php">
                                <div class="form-group">
                                  <!--  <input id="login" type="text" name="login" required data-msg="Please enter your username" class="input-material">
                                    --><input type="text" name="login" id="login" />

                                   <!-- <label for="login" class="label-material">User Name</label>
                                --></div>
                                <div class="form-group">
                                  <!--  <input id="pwd" type="password" name="pwd" required data-msg="Please enter your password" class="input-material">
                                   ...
                                   <!-- <label for="pwd" class="label-material">Password</label>
-->
                                </div>
