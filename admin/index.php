            ...
            <div class="container-fluid">
                <div class="navbar-holder d-flex align-items-center justify-content-between">
                    ...
                    <ul class="nav-menu list-unstyled d-flex flex-md-row align-items-md-center">
                        ...
                        <!-- Logout    -->
                        <li class="nav-item"><a href="view/authentificationmarketing.php" class="nav-link logout"> <span class="d-none d-sm-inline">Logout</span><i class="fa fa-sign-out"></i></a></li>
            ...
            <ul class="list-unstyled">
                ...
                <li><a href="#exampledropdownDropdown" aria-expanded="false" data-toggle="collapse"> <i class="icon-interface-windows"></i>Marketing </a>
                    <ul id="exampledropdownDropdown" class="collapse list-unstyled ">
                        <li><a href="view/espacevenement.php">Evenement</a></li>
                        <li><a href="view/espacepromotion.php">Promotion</a></li>
                    </ul>
                </li>
